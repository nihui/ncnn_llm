...
const static int attn_cnt = 36;
const static int rope_head_dim = 128;
const static float rope_theta = 1000000;
...
struct Beam {
    std::shared_ptr<qwen2_5_vl_3b_ctx> ctx;
    float score = 0.f;
    bool finished = false;
    std::unordered_set<int> tokens;
};

static std::shared_ptr<qwen2_5_vl_3b_ctx>
clone_ctx(const std::shared_ptr<qwen2_5_vl_3b_ctx>& src) {
    auto dst = std::make_shared<qwen2_5_vl_3b_ctx>();
...
qwen2_5_vl_3b::qwen2_5_vl_3b(std::string vision_embed_patch_param,
                                 std::string vision_embed_patch_bin,
                                 std::string vision_encoder_param,
                                 std::string vision_encoder_bin,
                                 std::string embed_param,
...
qwen2_5_vl_3b::~qwen2_5_vl_3b() = default;

// ==== Prefill implementation ====

std::shared_ptr<qwen2_5_vl_3b_ctx> qwen2_5_vl_3b::prefill(const std::string& input_text) const
{
    ...
    auto ctx = std::make_shared<qwen2_5_vl_3b_ctx>();
...
std::shared_ptr<qwen2_5_vl_3b_ctx> qwen2_5_vl_3b::prefill(const std::string& input_text, const cv::Mat& bgr, const std::shared_ptr<qwen2_5_vl_3b_ctx> ctx) const
{
    std::shared_ptr<qwen2_5_vl_3b_ctx> new_ctx = clone_ctx(ctx);
...
std::shared_ptr<qwen2_5_vl_3b_ctx> qwen2_5_vl_3b::prefill(const std::string& input_text, const std::shared_ptr<qwen2_5_vl_3b_ctx> ctx) const
{
    return this->prefill(input_text, cv::Mat(), ctx);
}

bool qwen2_5_vl_3b::decode(std::shared_ptr<qwen2_5_vl_3b_ctx> ctx, std::function<void(const std::string&)> callback) const
{
...
std::shared_ptr<qwen2_5_vl_3b_ctx> qwen2_5_vl_3b::generate(const std::shared_ptr<qwen2_5_vl_3b_ctx>& ctx_in, const GenerateConfig& cfg, std::function<void(const std::string&)> callback) const
{
...
int qwen2_5_vl_3b::get_visiual_features(const cv::Mat& bgr, ncnn::Mat& image_embeds, int& num_patches_w, int& num_patches_h) const
{
    if (bgr.empty())
    {
